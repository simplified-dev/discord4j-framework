...
public sealed interface FieldKind<V>
     ...
     *
     * @param choices the available {@link dev.simplified.discordapi.response.page.editor.field.Choice Choices}
     * @param nullable whether the user may clear the selection, returning null to the save handler
     * @param <V> the domain value type
     */
    record Choice<V>(
        @NotNull ConcurrentList<dev.simplified.discordapi.response.page.editor.field.Choice<V>> choices,
        boolean nullable
