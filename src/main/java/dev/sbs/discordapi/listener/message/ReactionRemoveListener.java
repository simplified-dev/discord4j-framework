...
public final class ReactionRemoveListener extends ReactionListener<ReactionRemoveEvent> {
    ...
    @Override
    protected @NotNull ReactionContext getContext(@NotNull ReactionRemoveEvent event, @NotNull Response cachedMessage, @NotNull Emoji emoji, @NotNull Optional<CachedResponse> followup) {
